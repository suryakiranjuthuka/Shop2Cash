...
<body id="productPage">
  ...
  <div id="productContainer">
    <section id="stepper">
      ...
      <div class="step">
        <span><svg viewBox="0 0 14 14"><use xlink:href="./img/all_svgs.svg#game1"></use></svg></span>
        <p>Play & Earn</p>
      </div>
      <span class="line"></span>
      <span class="slash">/</span>
        ...
        <div class="productDisplay">
          ...
          <footer>
            ...
            <div class="buttonsBlock">
              ...
              <a class="button play fancyBorder" href="./product_rewards.php"><img src="./img/gradient/gift.svg"><span>Play & Earn</span></a>
            </div>
          </footer>
        </div>
  ...
  <!-- ##### Include RedirectTo Block #####-->
  <?php include './php_includes/redirect_to.php'; ?>
