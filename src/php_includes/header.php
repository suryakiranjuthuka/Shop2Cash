<header id="header">
  <a href="./"><img id="logo" src="./img/shop2cash_logo.svg"></a>
  <nav>
    <a href="./">Home</a>
    ...
    <!-- Use ID "#account" before Login & ID "#accountMenu" after Login with PHP -->
    <div id="accountMenu">
      <div class="accountName"><svg viewBox="0 0 30 30"><use xlink:href="./img/all_svgs.svg#account"></use></svg><span class="name login">Login</span><span class="name account">Surya</span></div>
